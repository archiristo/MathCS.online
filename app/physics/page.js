  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-8 pt-24 max-w-7xl mx-auto flex flex-col items-center py-10 px-4">
      ...
      <p className="text-xl text-gray-400 mb-10 max-w-2xl">
        Discover the laws that govern the universe. From classical mechanics to quantum physics, gain a deeper understanding of physical reality through mathematical modeling and computer simulations.</p>
